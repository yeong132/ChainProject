...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 595101561L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QComment comment = new QComment("comment");

    public final BooleanPath commentAnswered = createBoolean("commentAnswered");
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.commentQna = inits.isInitialized("commentQna") ? new QQna(forProperty("commentQna")) : null;
    }
